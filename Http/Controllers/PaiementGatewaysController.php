...
class PaiementGatewaysController extends Controller
{
  ...
  public function depositWithGateway($user,$amount,$frais_variable,$frais_fixe,$id_mode_paiement,$redirect_url,$model=NULL,
                $model_id=NULL,$callbackfunction=null,$libelle=null,$auto_bay=false)
  {
    ...
    $paiement=Paiement::create([
      ...
      'user_id'=> $user->id,
      'montant'=>$amount,
      //'frais_variable,'=>$frais_variable,//ici correction 1
